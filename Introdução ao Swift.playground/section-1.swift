...
for (index, object) in enumerate(objects) {
	println("Object at index \(index) is \(object)")
}
...
public class Person : NSObject , Positivable {
	...
	var yearOfBirth: Int {
		var components = NSCalendar.currentCalendar().components(.CalendarUnitYear, fromDate: NSDate())
	...
	func aMethod(#havingSameParameterName: Double) {
